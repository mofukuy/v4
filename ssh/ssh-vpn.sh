...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu.sh"
wget -O menu-vmess "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-vmess.sh"
wget -O menu-vless "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-vless.sh"
wget -O running "https://raw.githubusercontent.com/fikripps/v4/main/menu/running.sh"
wget -O clearcache "https://raw.githubusercontent.com/fikripps/v4/main/menu/clearcache.sh"
wget -O menu-trgo "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-trgo.sh"
wget -O menu-trojan "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-trojan.sh"

# menu ssh ovpn
wget -O menu-ssh "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-ssh.sh"
...
# menu system
wget -O menu-set "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-set.sh"
wget -O menu-domain "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-domain.sh"
...
wget -O menu-webmin "https://raw.githubusercontent.com/fikripps/v4/main/menu/menu-webmin.sh"
wget -O speedtest "https://raw.githubusercontent.com/artanodrop/v4/main/ssh/speedtest_cli.py"
wget -O about "https://raw.githubusercontent.com/fikripps/v4/main/menu/about.sh"
wget -O auto-reboot "https://raw.githubusercontent.com/fikripps/v4/main/menu/auto-reboot.sh"
wget -O restart "https://raw.githubusercontent.com/fikripps/v4/main/menu/restart.sh"
wget -O bw "https://raw.githubusercontent.com/fikripps/v4/main/menu/bw.sh"
